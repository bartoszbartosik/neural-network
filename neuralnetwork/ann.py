...
class ANN:
    ...
    def sgd(self, y: np.ndarray, eta):
        ...
        for l in range(len(self.layers[1:])):
            self.layers[l+1].w -= eta * grad_w[l]
            self.layers[l+1].b -= eta * grad_b[l]
